...
(function( $ ) {
	...
	$( document ).ready( function() {
        ...
        * Testimonial slider
        */
        const $testimonialsSlider = $('section.testimonials')
        $testimonialsSlider.each(function (i, currentSection) {
            const $list = $(currentSection).find('.testimonials__list')
            ...
            if ($list.length) {
                $list.slick({
                    ...
                    arrows: true,
                    autoplay: false,
					appendDots:$(currentSection).find('.slider__dots-container'),
                    prevArrow: $(currentSection).find('.slider__button--left'),
                    nextArrow: $(currentSection).find('.slider__button--right'),
                })
            }
        })
		...
		* Client slider
		*/
		const $clientsSlider = $('section.clients')
		$clientsSlider.each(function (i, currentSection) {
			const $list = $(currentSection).find('.clients__list')
		...
		* Ccarousel slider
		*/
		const $ccarousel = $('.ccarousel__items')
		$ccarousel.each(function (i, currentSection) {
